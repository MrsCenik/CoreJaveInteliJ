...
public class FunctionalProgramming05 {
	...
	public static void main(String[] args) {
        ...
        System.out.println(checkAvaregeScoreToBeGreaterThan91(coursesList, 91));
	...
	public static boolean checkAvaregeScoreToBeGreaterThan91(List<Course> coursesList, double avg) {
	...
	//5)Sort the list elements according to the average score in ascending order and skip first 3rd one
