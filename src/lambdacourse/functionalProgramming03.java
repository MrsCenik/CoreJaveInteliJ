...
public class functionalProgramming03 {
	...
	public static void main(String[] args) {
        ...
        System.out.println();
        printDistinctSortedByLengthThenFirstChar(l);
        System.out.println();
//        removeIfTheLengthGreaterThanFive(l);
//        removeIfStartinWtihAOrEndingWithN(l);
        System.out.println();
	...
	//1) Create a method to print all list elements in upper case
		//1.Way
	public static void printUpoperCase(List<String> l) {
		l.stream().map(String :: toUpperCase).forEach(Utils :: printInTheSameLineWithASpace);
	}
		//2.Way
	public static void printUpoperCase2(List<String> l) {
	...
	public static void printDistinctSortedByLengthThenFirstChar(List<String> l) {
...
//	public static void removeIfStartinWtihAOrEndingWithN(List<String> l) {
...
//		l.stream().distinct().sorted(Comparator.reverseOrder()).forEach(t->System.out.print(t.length()*t.length()+ " ")); does not work... think on it
