...
public class Lists01 {
	...
	public static void main(String[] args) {
		...
		//2.Way: 
		//We will use Arrays.asList() method data type of array elements should be "non-primitive"
		...
		/*
		 when you run the following code, you will get "UpsupportedOpperationException"  because
		 the list is created from an array, and the list has some array features. The significant array feature
		 is to fix in length. So if you create a list from an array, you cannot use any list method which changes the size.
...
//		 System.out.println(l3c);
		 ...
		 System.out.println(l3c.contains(3)); // contains method can be used in converted list 
