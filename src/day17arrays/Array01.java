...
/*
			...
			3) Arrays accept just "primitives" as data type, 
				you can not store "non-primitive" data types in an array theoretically.
...
public class Array01 {
	...
	public static void main(String[] args) {
		...
		int a[] = new int [5]; // We should put how many data we will use in array inside the square brackets
