...
public class Arrays04 {
	...
	public static void main(String[] args) {
		/*
		 How to check is 2 arrays equal to each other
	    ...
	    */
		...
		String words[]= s4.split(" "); //java will find the spaces and cut the words from the spaces
		System.out.println(Arrays.deepToString(words)); //[Ali, Can, went, to, school]
		...
		System.out.println(chars.length); //22
		
		
		
		//How many characters except space were used in the String "Ali Can went to school"
		
		String charExpeptSpace[]= s4.replace(" " , "").split(""); //If we do not want to count specific character we will use replace() 
		System.out.println(Arrays.toString(charExpeptSpace)); //[A, l, i, C, a, n, w, e, n, t, t, o, s, c, h, o, o, l]
		System.out.println(charExpeptSpace.length); //18
		...
		/*
		 Scenarios:
		 To check the number of "a"s in a String we have 3 different scenarios:
		 1)"a" is not at the beginning and at the end ==> s5.startsWith("a") && s5.endsWith("a") = ama may I go to Alabama
		 2)"a" is at the beginning and at the end. ==> !s5.startsWith("a") && !s5.endsWith("a") = Mama may I go to AlabamaX
		 3) "a" is used just once at the beginning or at the end. ==> ama may I go to Alabamax
		 4) "a" is not at the beginning and at the end ==> Mama may I go to Alabama
		  
		 */
		String arr[]=s5.split("a");
		System.out.println(Arrays.toString(arr));
				//1.Way: It works but not recommended because number of scenarios is too much.
		...
		System.out.println("Second Way: " + (a1.length-a2.length)); // it works for all scenarios
