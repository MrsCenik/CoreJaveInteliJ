...
public class Iq06 {
	 ...
	 */
		...
		/*
		 	...
		 	2) From first element to maximum element, element should be in ascending order.
		 	3) From the maximum element to last element, element should be in descending order. 
		 
		 */

	public static void main(String[] args) {
		int a[] = { 0, 2, 5, 3, 1 };
		checkArrayToBeMountain(a);
		
	}
	
	public static void checkArrayToBeMountain(int a[]) {
		
					//1.Step:
		//Create a list
		List<Integer> list = new ArrayList<>();
		//Add all array element into the list
		...
		if (isTheSecondPartOk && isTheFirstPartOk) {
